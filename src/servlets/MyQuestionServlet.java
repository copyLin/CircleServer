...
public class MyQuestionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(currentId.equals("0")){
			list = questionDao.getMyQuestion(Integer.parseInt(userId));
		}else{
			list = questionDao.getMyQuestion(Integer.parseInt(userId), Integer.parseInt(currentId));
		}
		
		System.out.println("MyQuestionServlet_items: " + list);
